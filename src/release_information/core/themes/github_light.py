"""GitHub Light theme — Primer-flavoured light theme inspired by github.com.

Palette inspired by GitHub Primer's "Light" colour system.
Web search source: https://primer.style/foundations/color/overview
...
DESCRIPTION = "Clean light theme inspired by github.com / Primer with calm blues and greens."
PYGMENTS_STYLE = "default"  # Closest Pygments builtin to GitHub's syntax palette.
IS_DARK = False
SOURCE_URL: str | None = "https://primer.style/foundations/color/overview"

# Palette reference (Primer Light tokens):
#   Canvas      : #FFFFFF
#   Canvas subt : #F6F8FA
#   Border      : #D0D7DE / #D8DEE4
#   Foreground  : #1F2328
...
main.content strong { color: #CF222E; font-weight: 600; }
...
main.content tr:hover td { background: rgba(9, 105, 218, 0.04); }
