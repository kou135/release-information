"""One Dark theme — Atom-style dark theme with warm syntax accents.

Palette inspired by Atom's One Dark UI (originally from the Atom editor).
Web search source: https://github.com/atom/atom/tree/master/packages/one-dark-ui
Color palette is factual (hex values) and not subject to copyright; the theme
name "One Dark" is used in a nominative sense per Atom's MIT licence and the
many "<editor>-flavoured One Dark" community ports.
"""

from __future__ import annotations

DISPLAY_NAME = "One Dark"
DESCRIPTION = "Atom-flavoured dark theme with warm reds, greens, and blues on a muted slate."
PYGMENTS_STYLE = "one-dark"
IS_DARK = True
SOURCE_URL: str | None = "https://github.com/atom/atom/tree/master/packages/one-dark-ui"

# Palette reference (Atom One Dark syntax colours):
#   Background : #282C34
#   Panel      : #21252B
#   Foreground : #ABB2BF
#   Comment    : #5C6370
#   Accents    : #61AFEF (blue) #C678DD (purple) #E06C75 (red)
#                #98C379 (green) #E5C07B (yellow) #56B6C2 (cyan)
BASE_CSS = """
:root {
  --bg: #282C34;
  --bg-elevated: #21252B;
...
main.content strong { color: #E06C75; font-weight: 600; }
...
main.content tr:hover td { background: rgba(97, 175, 239, 0.06); }
