"""Gruvbox Dark theme — Pavel Pertsev's retro-groove warm dark palette.

Palette inspired by the gruvbox project by Pavel Pertsev (morhetz).
Web search source: https://github.com/morhetz/gruvbox
Color palette is factual (hex values) and not subject to copyright; the theme
name "Gruvbox" is used in a nominative sense per the upstream MIT licence and
the project's published "Palette" spec.
"""

from __future__ import annotations

DISPLAY_NAME = "Gruvbox Dark"
DESCRIPTION = "Retro-groove dark theme with warm earth tones (Pavel Pertsev's gruvbox)."
PYGMENTS_STYLE = "gruvbox-dark"
IS_DARK = True
SOURCE_URL: str | None = "https://github.com/morhetz/gruvbox"

# Palette reference (gruvbox "dark" / medium contrast):
#   bg0_h    : #1D2021  bg0    : #282828  bg0_s : #32302F
#   bg1      : #3C3836  bg2    : #504945  bg3   : #665C54
...
main.content strong { color: #FB4934; font-weight: 600; }
...
main.content tr:hover td { background: rgba(250, 189, 47, 0.06); }
