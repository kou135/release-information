...
Palette inspired by the Nord project by Sven Greb (Arctic Ice Studio).
Web search source: https://www.nordtheme.com/docs/colors-and-palettes
Color palette is factual (hex values) and not subject to copyright; the theme
name "Nord" is used in a nominative sense per the project's MIT licence and
common community convention for "<editor>-flavoured Nord" ports.
"""

from __future__ import annotations

DISPLAY_NAME = "Nord"
DESCRIPTION = "Arctic, north-bluish color palette designed for clarity and minimal eye strain."
PYGMENTS_STYLE = "nord"
IS_DARK = True
SOURCE_URL: str | None = "https://www.nordtheme.com/docs/colors-and-palettes"

# Palette reference (from the official Nord docs):
...
main.content strong { color: #EBCB8B; font-weight: 600; }
...
main.content tr:hover td { background: rgba(136, 192, 208, 0.06); }
