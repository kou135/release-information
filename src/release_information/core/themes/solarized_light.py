"""Solarized Light theme — Ethan Schoonover's precision-designed light palette.

Palette inspired by the Solarized project by Ethan Schoonover.
Web search source: https://ethanschoonover.com/solarized/
Color palette is factual (hex values) and not subject to copyright; the theme
name "Solarized" is used in a nominative sense per the upstream MIT licence
and the project's published "Sixteen Colors" colourimetric spec.
"""

from __future__ import annotations

DISPLAY_NAME = "Solarized Light"
DESCRIPTION = "Ethan Schoonover's precision-designed warm light palette with selective contrast."
PYGMENTS_STYLE = "solarized-light"
IS_DARK = False
SOURCE_URL: str | None = "https://ethanschoonover.com/solarized/"

# Palette reference (Solarized "Sixteen Colors"):
#   base3   : #FDF6E3  (background, light mode "base" canvas)
#   base2   : #EEE8D5  (background elevated / panel)
#   base1   : #93A1A1  (foreground muted)
#   base00  : #657B83  (body text foreground)
#   base01  : #586E75  (emphasised text)
#   base03  : #002B36  (deep text contrast)
#   yellow  : #B58900
#   orange  : #CB4B16
#   red     : #DC322F
#   magenta : #D33682
...
main.content strong { color: #DC322F; font-weight: 600; }
main.content em { color: #002B36; font-style: italic; }
...
main.content tr:hover td { background: rgba(181, 137, 0, 0.05); }
