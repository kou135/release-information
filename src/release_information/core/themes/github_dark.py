"""GitHub Dark theme — Primer-flavoured dark theme inspired by github.com.

Palette inspired by GitHub Primer's "Dark" (default dark) colour system.
Web search sources:
  - https://primer.style/foundations/color/overview
  - https://github.com/projekt0n/github-nvim-theme (github_dark palette,
    which is a faithful port of Primer dark default)
Color palette is factual (hex values) and not subject to copyright; the theme
name "GitHub" is GitHub Inc.'s trademark and is used here in a nominative,
descriptive sense (Primer CSS itself is published under the MIT licence),
following the same precedent as the existing github-light theme.

Pygments style: "github-dark" (confirmed present in Pygments builtin styles
via get_all_styles() in the project venv).
"""

from __future__ import annotations

DISPLAY_NAME = "GitHub Dark"
DESCRIPTION = "Dark theme inspired by github.com / Primer's default dark mode with calm blue accents."
PYGMENTS_STYLE = "github-dark"  # Confirmed Pygments builtin: True in get_all_styles().
IS_DARK = True
SOURCE_URL: str | None = "https://primer.style/foundations/color/overview"

# Palette reference (Primer Dark / default dark tokens):
#   canvas.default  : #0d1117  (--bg)
#   canvas.subtle   : #161b22  (--bg-elevated)
#   canvas.inset    : #010409  (--bg-code)
#   fg.default      : #e6edf3  (--fg)
#   fg.muted        : #8b949e  (--fg-muted)
#   fg.subtle       : #6e7681  (--fg-dim)
#   border.default  : #30363d  (--border)
#   border.muted    : #21262d  (--border-soft)
#   accent.fg       : #2f81f7  (--accent / --link)
#   blue scale      : #58a6ff  (--accent-soft)
#   danger.fg       : #f85149  (strong colour, mirrors github-light's #CF222E)
#   syntax string   : #a5d6ff  (inline code colour)
BASE_CSS = """
:root {
  --bg: #0d1117;
  --bg-elevated: #161b22;
...
main.content strong { color: #f85149; font-weight: 600; }
...
main.content tr:hover td { background: rgba(47, 129, 247, 0.08); }
