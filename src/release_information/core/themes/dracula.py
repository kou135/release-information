"""Dracula theme — a dark theme using the iconic purple/pink/cyan palette.

Palette inspired by the Dracula project by Zeno Rocha.
Web search source: https://draculatheme.com/contribute
Color palette is factual (hex values) and not subject to copyright; the theme
name "Dracula" is used in a nominative sense per the upstream MIT licence and
the project's published "How to contribute" spec which encourages ports.
"""

from __future__ import annotations

DISPLAY_NAME = "Dracula"
DESCRIPTION = "Classic dark theme with purple, pink, and cyan accents on a deep slate background."
PYGMENTS_STYLE = "dracula"
IS_DARK = True
SOURCE_URL: str | None = "https://draculatheme.com/contribute"

# Palette reference (from the official Dracula spec):
#   Background : #282A36
#   Current ln : #44475A
#   Foreground : #F8F8F2
#   Comment    : #6272A4
...
main.content strong { color: #FF79C6; font-weight: 600; }
...
main.content tr:hover td { background: rgba(189, 147, 249, 0.06); }
