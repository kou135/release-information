"""Tokyo Night theme — clean, dark theme inspired by the lights of Tokyo at night.

Palette inspired by the Tokyo Night project by Enkia (originally a VSCode theme).
Web search source: https://github.com/enkia/tokyo-night-vscode-theme
Color palette is factual (hex values) and not subject to copyright; the theme
name "Tokyo Night" is used in a nominative sense per the upstream MIT licence
and common community convention for "<editor>-flavoured Tokyo Night" ports.
"""

from __future__ import annotations

DISPLAY_NAME = "Tokyo Night"
DESCRIPTION = "Clean dark theme inspired by the night lights of Tokyo with vivid neon accents."
PYGMENTS_STYLE = "one-dark"  # Pygments has no native tokyo-night; one-dark hues are closest.
IS_DARK = True
SOURCE_URL: str | None = "https://github.com/enkia/tokyo-night-vscode-theme"

# Palette reference (from the upstream "Tokyo Night" / "Storm" variant):
#   Background : #1A1B26  (bg) / #16161E (deep) / #24283B (storm panel)
#   Foreground : #C0CAF5  (default text)
#   Comment    : #565F89
#   Accents    : #7AA2F7 (blue) #BB9AF7 (magenta) #7DCFFF (cyan)
#                #9ECE6A (green) #E0AF68 (yellow) #F7768E (red)
BASE_CSS = """
:root {
  --bg: #1A1B26;
  --bg-elevated: #24283B;
...
main.content strong { color: #F7768E; font-weight: 600; }
...
main.content tr:hover td { background: rgba(187, 154, 247, 0.06); }
